...
var Main = {
  ...
  Events: {
    ...
    click_Login: function click_Login(e) {
      ...
      fetch("".concat(this.URL_API, "Login"), {
        ...
        if (data.message === 'success') {
          _this.fetchResponses.successLogin();

          _this.fetchResponses.structureLayout(data);
    ...
    click_listOrder: function click_listOrder(e) {
      var ordersList = document.querySelector('.ordersList'); //Fazer fetch para orders, mandando o ID desse usuário que está no input hidden para a API para que ela faça a pesquisa no banco de dados e me devolva os pedidos desse cliente
    },
  ...
  fetchResponses: {
    ...
    structureLayout: function structureLayout(data) {
